...
opcode_entry opcode_table [512] = {
  ...
  /* 0x3c */	IDEXW(I2a,xor,1), IDEX(I2a,xor), EMPTY, EMPTY,
  ...
  /* 0x98 */	IDEX(r,cwtl), IDEX(r,cltd), EMPTY, EMPTY,
  ...
  /* 0xc8 */	EMPTY, EXW(leave,4), EMPTY, EMPTY,
  ...
  /* 0xe8 call->i386->Av->word/dword*/	IDEX(J,call), IDEX(J,jmp), EMPTY, IDEXW(J,jmp,1),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(mov_Eb2Gv,movzx), IDEX(mov_Ew2Gv,movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(mov_Eb2Gv,movsx), IDEX(mov_Ew2Gv,movsx),
